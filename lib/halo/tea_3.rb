...
module Crypt
    class TEA
        ...
        #-------------------------------------------------------------
        def self.encrypt(plain_text,pass_phrase, opts = {})
            tea =TEA.new
            tea.encrypt(plain_text,pass_phrase, opts)
        end
        ...
        # is a text pass phrase
        #-------------------------------------------------------------
        def self.decrypt(cipher_text,pass_phrase, opts = {})
            tea = TEA.new
            tea.decrypt(cipher_text,pass_phrase, opts)
        end


        #-------------------------------------------------------------
        def encrypt(plain_text,pass_phrase, opts = {})
        ...
        #-------------------------------------------------------------
        def decrypt(cipher_text,pass_phrase, opts = {})

            key = opts[:key] || passphrase_to_key(pass_phrase)
