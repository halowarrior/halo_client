...
# 173 1.1 2006-08-12 05:01  Jordan Callicoat  
# Changes since last version::
# Ruby 1.9 compatibility.

# In Ruby 1.9 String#[] with a single index returns a character instead of an ordinal (i.e., Fixnum), but adds a String#ord function to get the ordinal of a character. Ruby 1.8 just gives you the ordinal.

# To make it work with both #ord needs to be called on each plain_text index in #encrypt and an #ord method that returns self needs to be added to Fixnum.

# Great snippet, BTW
# 141 1.0 2006-02-28 14:49  Jeremy Hinegardner  
